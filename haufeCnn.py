...
wConv1  = [5,5,1,40] # kernel size, kernel size, input dimension (maps), output dimension;
wConv2  = [5,5, 40,100] # kernel size, kernel size, input dimension (maps), output dimension;
fcSize = [15*25*100,300] 
outsideLayer = [fcSize[1],2]


# Data directories (change it to yours)
nom = 'Raw'
tensorboardDir = '/Users/leonardo/Desktop/IBMcnn/haufe/tb' 
imgDir='/Users/leonardo/Desktop/IBMcnn/haufe/images'
singleKernelDir = '/Users/leonardo/Desktop/IBMcnn/haufe/images/singleKernel.png'
weightDir = '/Users/leonardo/Desktop/IBMcnn/haufe/weights'
...
with tf.name_scope('xent'):
	...
	variable_summaries(cross_entropy,'X-entropy')
...
w1F= open(weightDir + '/cnnTestw1.pickle','w')
w2F=open(weightDir + '/cnnTestw2.pickle','w')
w3F=open(weightDir + '/cnnTestw3.pickle','w')
w4F=open(weightDir + '/cnnTestw4.pickle','w')
pickle.dump(w1,w1F)
pickle.dump(w2,w2F)
pickle.dump(w3,w3F)
pickle.dump(w4,w4F)
